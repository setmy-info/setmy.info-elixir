defmodule SetmyInfo.DemoModuleA.Application do
  @moduledoc """
  OTP application and supervision tree for `demo_module_a`.
  ...
  def start(_type, _args) do
    children =
      if serve?() do
        [
          {Plug.Cowboy,
           scheme: :http,
           plug: SetmyInfo.DemoModuleA.Web,
    ...
    Supervisor.start_link(children,
      ...
      name: SetmyInfo.DemoModuleA.Supervisor
    )
  end
  ...
  defp port, do: Application.fetch_env!(:demo_module_a, :port)
  ...
  defp serve?, do: Application.get_env(:demo_module_a, :serve, true)
end
