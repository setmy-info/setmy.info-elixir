defmodule SetmyInfo.DemoModuleC.Application do
  @moduledoc """
  OTP application and supervision tree for `demo_module_c`.
  ...
  def start(_type, _args) do
    children =
      if serve?() do
        [
          {Plug.Cowboy,
           scheme: :http,
           plug: SetmyInfo.DemoModuleC.Web,
    ...
    Supervisor.start_link(children,
      ...
      name: SetmyInfo.DemoModuleC.Supervisor
    )
  end
  ...
  defp port, do: Application.fetch_env!(:demo_module_c, :port)
  ...
  defp serve?, do: Application.get_env(:demo_module_c, :serve, true)
end
