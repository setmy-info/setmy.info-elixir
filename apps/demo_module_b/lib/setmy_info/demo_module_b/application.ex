defmodule SetmyInfo.DemoModuleB.Application do
  @moduledoc """
  OTP application and supervision tree for `demo_module_b`.
  ...
  def start(_type, _args) do
    children = [
      {Plug.Cowboy,
       scheme: :http, plug: SetmyInfo.DemoModuleB.Web, options: [port: port(), ip: {127, 0, 0, 1}]}
    ]

    Supervisor.start_link(children,
      strategy: :one_for_one,
      name: SetmyInfo.DemoModuleB.Supervisor
    )
  end
